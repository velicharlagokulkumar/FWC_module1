...
\title{\mytitle}
\author{\myauthor\hspace{1em}\\\contact\\FWC22034\hspace{6.5em}IITH\hspace{0.5em}\mymodule\hspace{6em}ASSIGN-2}
\date{}
\begin{document}
	\maketitle
	\tableofcontents
...
\begin{center}
\begin{center}
\fbox{\parbox{8.5cm}{\url{https://github.com/velicharlagokulkumar/FWC_module1/blob/main/Assembly/codes/method_1/method_1.asm}}}
\end{center}
\textbf{ubuntu command line commands}
\begin{center}
\begin{lstlisting}
avra method_1.asm ...........................................for running 
avrdude -p atmega328p -c arduino -P /dev/ttyACM0 -b 115200 -U flash:w:method_1.hex.............for flashing
\end{lstlisting}
\end {center}
	\begin{tabularx}{0.4\textwidth} { 
  | >{\centering\arraybackslash}X 
...
\begin{center}
\fbox{\parbox{8.5cm}{\url{https://github.com/velicharlagokulkumar/FWC_module1/blob/main/Assembly/codes/method_2/method_2.asm}}}
\end{center}
\subsection{METHOD-3}
...
\begin{center}
\fbox{\parbox{8.5cm}{\url{https://github.com/velicharlagokulkumar/FWC_module1/blob/main/Assembly/codes/method_3/method_3.asm}}}
\end{center}
