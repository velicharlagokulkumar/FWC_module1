...
\begin{center}
\fbox{\parbox{8.5cm}{\url{https://github.com/velicharlagokulkumar/FWC_module1/blob/main/IDE/codes/method_1/src/method_1.cpp}}}
...
\begin{center}
\fbox{\parbox{8.5cm}{\url{https://github.com/velicharlagokulkumar/FWC_module1/blob/main/IDE/codes/method_2/src/method_2.cpp}}}
\end{center}
\subsection{METHOD-3}
...
\begin{center}
\fbox{\parbox{8.5cm}{\url{https://github.com/velicharlagokulkumar/FWC_module1/blob/main/IDE/codes/method_3/src/method_3.cpp}}}
\end{center}
