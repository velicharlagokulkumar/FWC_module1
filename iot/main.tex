...
\end{center}
\begin{lstlisting}
svn co https://github.com/velicharlagokulkumar/iot/trunk/codes/setup
cd  setup
pio run
pio run -t upload
\end{lstlisting}
...
\begin{center}
\fbox{\parbox{8cm}{\url{https://github.com/velicharlagokulkumar/FWC_module1/blob/main/iot/codes/src/main.cpp}}}
\end{center}
through 
\begin{lstlisting}
pio run 
